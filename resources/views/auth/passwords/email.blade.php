      ...
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        @csrf
          <div class="mb-1">
            ...
            <input class="form-control" id="email" type="text" name="email" placeholder="{{ __('E-Mail Address') }}" aria-describedby="email" required autocomplete="email" autofocus tabindex="1" />
          </div>
