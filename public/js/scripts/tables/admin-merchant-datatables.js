    ...
    if ("laravel" === $("body").attr("data-framework") && e.length) {
        var n = e.DataTable({
            ...
            columnDefs: [{
                ...
                orderable: !1,
                render: function(e, t, a, s) {
                    return '<a href="'+a.edit_url+'" class="item-edit">' + feather.icons.edit.toSvg({
                        class: "font-small-4"
                    }) + "</a>"
                }
            }],
        ...
        $("div.head-label").html('<h6 class="mb-0">Merchants List</h6>')
    }
    $( ".clickforadd" ).click(function() {
        window.location = '/admin/merchants/add';
    });
});
