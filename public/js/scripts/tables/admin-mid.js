$(document).ready(function() {
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            addOnSubmit(e){
                this.currentFormType = 'addMidForm';
                e.preventDefault();
                var _that = this;
                
                _that.isLoader = true;

                var addFormData = $("#addMidForm").serializeArray();
                var ajaxUrl = $('#addMidForm').attr('action');
                _that.message = '';
		        _that.status = null;
                var addRequest = $.ajax({
                    method: "POST",
            ...
            onLoad() {
                ...
                var _that = this;
                setTimeout(function(){ _that.pageloader = false; }, 1000);
            },
            validationLoad(){
