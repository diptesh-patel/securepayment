$(document).ready(function() {
    ...
    if ("laravel" === $("body").attr("data-framework") && e.length) {
        var n = e.DataTable({
            ...
            columnDefs: [{
                ...
                render: function(e, t, a, s) {
                    ...
                    return '<div class="d-flex justify-content-left align-items-center"><div class="avatar ' + ("" === l ? " bg-light-" + i + " " : "") + ' me-1">' + d + '</div><div class="d-flex flex-column"><span class="emp_name text-truncate fw-bold">' + n + '</span><small class="emp_post text-truncate '+tc+'">' + r + "</small></div></div>"
                }
            }, {
            ...
            },
            {
                ...
                orderable: !1,
                render: function(e, t, a, s) {
                    return '<a href="'+a.edit_url+'" title="Edit User" class="item-edit">' + feather.icons.edit.toSvg({
                        class: "font-small-4"
                    }) + "</a>"+' <a href="'+a.assign_url+'" class="item-edit" title="Assign merchant">'+feather.icons['refresh-cw'].toSvg({
                        class: "font-small-4"
                    })+'</a>'
                }
            }],
        ...
        $("div.head-label").html('<h6 class="mb-0">Users List</h6>')
    }
